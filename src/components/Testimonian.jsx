import ima1 from "../assets/22.jpg"
import ima2 from "../assets/14.jpg"
import ima3 from "../assets/13.jpg"
    ...
    <div>
        <div className='my-24 md:px-14 px-4 max-w-screen-2xl mx-auto '>
            ...
            <div className='text-center ' >
                ...
                <span className='text-[#39CF02]'>Jackets!</span>  for Men </h2>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-20 mb-4 text-center'>
                ...
                transition-all duration-200 ease-in cursor-pointer' data-aos="fade-down">
                    ...
                    <div className='p-4 mb-4'>
                        ...
                        <span className="text-3xl">£310.00</span>
                        <h2 className='text-[#1f1e1e] text-2xl mt-4 font-semibold'>Biez Modular Puffer Jacket</h2>
                ...
                transition-all duration-200 ease-in cursor-pointer' data-aos="fade-up">
                    ...
                    <div className='p-4 mb-4'>
                        ...
                        <span className="text-3xl">£245.00</span>
                        <h2 className='text-[#1f1e1e] text-2xl mt-4 font-semibold'>Terez Puffer Jacket</h2>
                ...
                transition-all duration-200 ease-in cursor-pointer' data-aos="fade-down">
                    ...
                    <div className='p-4 mb-4'>
                        ...
                        <span className="text-3xl">£210.00</span>
                        <h2 className='text-[#1f1e1e] text-2xl mt-4 font-semibold'>Lapaz Puffer Jacket</h2>
