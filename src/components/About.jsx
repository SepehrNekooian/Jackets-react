import Aboutimg1 from "../assets/14.jpg"
import Aboutimg2 from "../assets/22.jpg"
    ...
    <div className="md:px-14 p-4 max-w-screen-2xl mx-auto space-y-10" id="About Us">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="md:w-2/4" data-aos="fade-left">
                <h2 className="md:text-5xl text-3xl font-bold text-[#1f1e1e] mb-5 leading-normal ">
                Men’s coats and jackets Usa Hockey's <span className="text-[#39CF02]">passion</span> for design</h2>
                ...
                <button className="bg-[#39CF02] text-white px-8 py-4 transition-all duration-300 rounded
                 hover:text-[#1f1e1e] hover:bg-[#6C6765]">DISCOVER MORE</button>
            </div>
