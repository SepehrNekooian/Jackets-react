...
const Footer = () => {
  return (
    <div className='bg-[#1f1e1e] md:px-14 p-4 max-w-screen-2xl mx-auto text-white'>

        <div className='my-12 flex flex-col md:flex-row gap-10'>
            <div className='md:w-1/2 space-y-8'>
                <a href="/">
                <img src={Logo} alt=""  className="h-20"/></a>
                <p className='md:w-1/2'>Sign up to our newsletter</p>
                <div>
            ...
            <div className='md:w-1/2 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start'>
                ...
                <div className='space-y-4 mt-5'>
                    ...
                    <ul className='space-y-3'>
                        <a href="/" className='block hover:text-gray-300'>Men</a>
                        <a href="/" className='block hover:text-gray-300'>Women</a>
                        <a href="/" className='block hover:text-gray-300'>Kids</a>
                        <a href="/" className='block hover:text-gray-300'>Bags & Equipment</a>
                    </ul>
                </div>
                ...
                <div className='space-y-4 mt-5'>
                    ...
                    <ul className='space-y-3'>
                        <a href="/" className='block hover:text-gray-300'>Track your order</a>
                        <a href="/" className='block hover:text-gray-300'>Delivery</a>
                        <a href="/" className='block hover:text-gray-300'>Returns</a>
                        <a href="/" className='block hover:text-gray-300'>Students Discount</a>
                    </ul>
                </div>
        ...
        <div className='flex flex-col sm:flex-row gap-8 sm:items-center justify-between my-8'>
            <p>@ USA HOCKEY! --- 2025. All rights reserved.</p>
